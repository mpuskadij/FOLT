...
import edu.unizg.foi.nwtis.mpuskadij20.vjezba_08_dz_3.jpa.entiteti.Korisnici;
import edu.unizg.foi.nwtis.mpuskadij20.vjezba_08_dz_3.jpa.entiteti.Korisnici_;
...
public class KorisniciFacade extends EntityManagerProducer implements Serializable {
  ...
  /**
   * Pretvori iz {@link Korisnici} u {@link Korisnik}
   * @param k - korisnik
   * @return korisnik
   */
  ...
  /**
   * Pretvori iz {@link Korisnik} u {@link Korisnici}
   * @param k - korisnik
   * @return korisnik
   */
  ...
  /**
   * Pretvori listu korisnici u korisnik
   * @param korisniciE - entiteti
   * @return lista zapisa {@link Korisnik}
   */
